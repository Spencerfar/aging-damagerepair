...
import os
import argparse
from damagerepair_counting import prune
...
data,_,_ = prune(data, list(deficits), 'Mouse ID', 'age_months')
...
all_df.to_csv('../datasets/schultz_repair_deficits_pruned.csv')
...
all_df = pd.concat(all_df)
all_df.to_csv('../datasets/schultz_damage_deficits_pruned.csv')
