...
###### mouse dataset 1
mice <- read.csv('../datasets/enalapril_repair_deficits_pruned.csv', header = TRUE, sep = ",")
...
write.csv(combined.fit, '../figure_data/figure5_supplement3/mouse1_repair_timescale.csv')
...
enalapril.repair <- ggplot() +
    ...
    theme(
        ...
        plot.margin = unit(c(0.01, 0, 0, 0.01), "cm")) + ggtitle("d) Mouse dataset 1\n    (Keller et al. 2019)") +
...
mice <- read.csv('../datasets/enalapril_damage_deficits_pruned.csv', header = TRUE, sep = ",")
...
# save figure source data
write.csv(combined.fit, '../figure_data/figure5_supplement3/mouse1_damage_timescale.csv')
...
##### mouse dataset 2
mice <- read.csv('../datasets/exercise_repair_deficits_pruned.csv', header = TRUE, sep = ",")
mice$diff <- mice$repair.age - mice$damage.age
...
# save figure source data
write.csv(combined.fit, '../figure_data/figure5_supplement3/mouse2_repair_timescale.csv')
...
exercise.repair <- ggplot() +
    ...
    theme(
        ...
        legend.position=c(.74,0.9),
        legend.text = element_text(size = 6),
        plot.margin = unit(c(0.01, 0, 0, 0.01), "cm")) + ggtitle('e) Mouse dataset 2\n    (Bisset et al. 2022)') +
    scale_y_continuous(breaks=c(0, 0.25, 0.5, 0.75, 1.0),
                       label = c("0.0", "0.25", "0.5", "0.75", "1.0"), limits = c(0.0, 1.0)) +
...
mice <- read.csv('../datasets/exercise_damage_deficits_pruned.csv', header = TRUE, sep = ",")
mice$diff <- mice$damage.age - mice$repair.age
...
# save figure source data
write.csv(combined.fit, '../figure_data/figure5_supplement3/mouse2_damage_timescale.csv')
...
###### mouse dataset 3
mice <- read.csv('../datasets/schultz_repair_deficits_pruned.csv', header = TRUE, sep = ",")
mice$diff <- mice$repair.age - mice$damage.age
...
# save figure source data
write.csv(combined.fit, '../figure_data/figure5_supplement3/mouse3_repair_timescale.csv')
...
schultz.repair <- ggplot() +
    ...
    theme(
        ...
        legend.position=c(.68,0.9),
        legend.text = element_text(size = 6),
        plot.margin = unit(c(0.01, 0, 0, 0.01), "cm")) + ggtitle('f) Mouse dataset 3\n    (Schultz et al. 2020)') +
    scale_y_continuous(breaks=c(0, 0.25, 0.5, 0.75, 1.0),
                       label = c("0.0", "0.25", "0.5", "0.75", "1.0"), limits = c(0.0, 1.0)) +
    scale_x_continuous(breaks=c(0, 2, 4, 6, 8),
                       label = c("0", "2", "4", "6", "8")) +
...
mice <- read.csv('../datasets/schultz_damage_deficits_pruned.csv', header = TRUE, sep = ",")
mice$diff <- mice$damage.age - mice$repair.age
...
# save figure source data
write.csv(combined.fit, '../figure_data/figure5_supplement3/mouse3_damage_timescale.csv')
...
ggsave("mouse_timescales_resilience.pdf", img, , width=8, height=2.)
...
ggsave("mouse_timescales_both.pdf", img, , width=8, height=2.5)
